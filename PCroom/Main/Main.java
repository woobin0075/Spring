...
import PCroom.AutoWebConfig.AutoWebConfig;
...
import PCroom.Service.MainService;
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        SuperVisorService superVisorService = ac.getBean(SuperVisorService.class);
        MemberService memberService = ac.getBean(MemberService.class);
        GuestService guestService = ac.getBean(GuestService.class);
